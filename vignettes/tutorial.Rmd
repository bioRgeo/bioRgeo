...
knitr::kable(data.frame(
  Acronym = c("greedy", "betweenness", "walktrap", "louvain", "spinglass",
              "leading_eigen", "label_prop", "dorman", "netcarto",
              "beckett", "oslom", "infomap"),
  ...
  `Source R package` = c(
    rep("igraph", 7), "bipartite (not yet implemented)", "rnetcarto",
    "none (code from https://github.com/sjbeckett/weighted-modularity-LPAwbPLUS)", 
  ...
  References = c("Clauset et al., 2011", "Newman & Girvan, 2011",
                 ...
                 "Raghavan et al., 2006", "",
                 "Guimerà & Amaral, 2005", "Beckett, 2016",
                 "Lancichinetti et al., 2010", "Rosvall et al., 2009")))

# Finish table
# Implement bipartite:: => dorman methods in network()
# Implement DIRTLPAwb+
...
bip2 <- network(dat = sp_mat, algo = "LPAwb", weight = FALSE)
...
mbm <- microbenchmark(
  ...
  beckett = network(dat = sp_mat, algo = "LPAwb", weight = FALSE),
