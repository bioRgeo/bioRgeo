...
net_bio <-  community(
  ...
  algo = c("greedy", "beckett", "louvain", "walktrap", "infomap"),
  weight = FALSE, input = "data.frame", site = "site", sp = "sp",
  N = 10)
...
mbm <- microbenchmark(
  ...
  oslom = community(
    dat = sp_proj[which(sp_proj$simpson> 0), ], algo = "oslom", weight = FALSE,
    input = "data.frame", site = "site", sp = "sp", N = 10, n_runs = 1,
    t_param = 0.1, cp_param = 0.5, hr = 0,
    oslom_id1 = "id1", oslom_id2 = "id2", oslom_proj = "simpson"),
