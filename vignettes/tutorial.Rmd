...
knitr::kable(data.frame(
  Acronym = c("ward.D", "ward.D2", "single", "complete", "average",
              "mcquitty", "median", "centroid", "dbscan", "gmm", "diana",
              "pam"),
  Method = c("Ward.D", "Ward.D2", "single", "complete", "UPGMA",
              "WPGMA", "WPGMC", "UPGMC", "dbscan", "GMM", "diana",
              "PAM"),
  Category = c("Hierarchical", "Partitionning"),
  Supervision = c("Yes", "No"),
  `Short description` = c()))
...
po <- kmeans(sp_mat, centers = 4, iter.max = 10, nstart = 1)
po <- kmeans(sp_proj_dist, centers = 4, iter.max = 10, nstart = 1)
