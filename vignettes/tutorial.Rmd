...
*bioRgeo* contains a function \code{**cluster()**} that gathers several classical methods of clustering. Before applying any of the available method, **cluster()** computes a distance matrix based on Euclidean distances between pairs of sites.
...
Kaufman, L. & Rousseeuw, P.J. (1990)Finding groups in data:an introduction to cluster analysis. Wiley Series in Probabilityand Mathematical Statistics. Wiley, New York.
